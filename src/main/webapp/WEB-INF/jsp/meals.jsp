...
<body>
<script type="application/javascript" src="resources/js/topjava.common.js" defer></script>
<script type="application/javascript" src="resources/js/topjava.meals.js" defer></script>
...
<div class="jumbotron pt-4">
    <div class="container">
        ...
        <div id="datatable_wrapper" class="dataTables_wrapper no-footer">
            <div class="row">
                <div class="col-sm-12">
                    <table class="table table-striped dataTable no-footer" id="datatable" role="grid"
                        ...
                        <c:forEach items="${meals}" var="meal">
                            ...
                            <tr data-mealExcess="${meal.excess}">
                                ...
                                <td>${meal.calories}</td>
                                <td>
                                    <a onclick="update(${meal.id})">
                                        <span class="fa fa-pencil"></span>
                                    </a>
                                </td>
                                <td>
                                    <a onclick="deleteRow(${meal.id})">
