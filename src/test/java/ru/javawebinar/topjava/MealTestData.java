...
public class MealTestData {
    ...
    public static TestMatcher<Meal> MEAL_MATCHER2 = TestMatcher.usingFieldsComparator();

    public static final int MEAL1_ID = START_SEQ + 2;
    public static final int ADMIN_MEAL_ID = START_SEQ + 9;
    public static final int ADMIN_MEAL_ID2 = ADMIN_MEAL_ID + 1;
    ...
    public static final Meal ADMIN_MEAL2 = new Meal(ADMIN_MEAL_ID2, of(2020, Month.JANUARY, 31, 21, 0), "Админ ужин", 1500, UserTestData.ADMIN);
