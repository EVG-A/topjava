...
public class MealsUtil {
    ...
    public static final List<Meal> MEALS = Arrays.asList(
            ...
            new Meal(2,LocalDateTime.of(2020, Month.JANUARY, 30, 10, 0), "Завтрак02", 500),
            new Meal(2,LocalDateTime.of(2020, Month.JANUARY, 30, 13, 0), "Обед02", 1000),
            new Meal(2,LocalDateTime.of(2020, Month.JANUARY, 30, 20, 0), "Ужин02", 500),
            new Meal(2,LocalDateTime.of(2020, Month.JANUARY, 31, 0, 0), "Еда на граничное значение02", 100),
            new Meal(2,LocalDateTime.of(2020, Month.JANUARY, 31, 10, 0), "Завтрак02", 1000),
            new Meal(2,LocalDateTime.of(2020, Month.JANUARY, 31, 13, 0), "Обед02", 500),
            new Meal(2,LocalDateTime.of(2020, Month.JANUARY, 31, 20, 0), "Ужин02", 410)
    );
